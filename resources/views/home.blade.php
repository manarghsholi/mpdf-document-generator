...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" 
    ...
    <script src="https://cdn.tiny.cloud/1/56gpt9jb4rykp2yc8adlrhuani2ez6ldjrrrok1bsk3dveq7/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
  <script>
    tinymce.init({
      selector: '.editor',
      toolbar: 
...
<body>
  <div class="container my-4 mx-auto">
    ...
    <div class="text-center">
        <button type="submit" name="formid" class="btn btn-primary">Create</button>
    </div>
  </div>
